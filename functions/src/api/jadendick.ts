 ...
 */
export const hello_jaden = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const jaden_dick = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "jadendick32@gmail.com"
    }
