 ...
 */
export const hello_ryan = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const ryan_noeske = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "rbn170000@utdallas.edu"
    }
