 ...
 */
export const hello_hannah = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const hannah_eason = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "hse200000@utdallas.edu"
    }
