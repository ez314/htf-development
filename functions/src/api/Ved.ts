 ...
 */
export const hello_ved = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const ved_sharma = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "vedsharma1423@gmail.com"
    }
