 ...
 */
export const hello_nathan_adam = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const nathan_adam = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "nla190001@utdallas.edu"
    }
