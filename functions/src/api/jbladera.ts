 ...
 */
export const hello_jb = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const jb_ladera = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "johnjbladera@gmail.com"
    }
