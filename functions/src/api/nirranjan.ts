 ...
 */
export const hello_nirranjan = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const nirranjan_akilan = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "anirranjan@gmail.com"
    }
