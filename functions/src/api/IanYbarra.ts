 ...
 */
export const hello_first_Ian = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const ian_Ybarra = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "ianybarra2000@gmail.com"
    }
