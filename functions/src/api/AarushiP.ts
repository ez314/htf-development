 ...
 */
export const hello_AarushiP = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const AarushiP = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "axp180064@utdallas.edu"
    }
