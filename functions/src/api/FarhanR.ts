 ...
 */
export const hello_farhan = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const farhan_rahman = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "sxr190032@utdallas.edu"
    }
