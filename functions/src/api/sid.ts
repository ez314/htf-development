 ...
 */
export const hello_sid = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const sid_khabiya = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "skhabiya@ucsc.edu"
    }
