 ...
 */
export const hello_sai = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const sai_bommisetty = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "EWizard512@gmail.com"
    }
