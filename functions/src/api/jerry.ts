 ...
 */
export const hello_jerry = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const jerry_teng = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "Jerry.Teng@UTDallas.edu"
    }
