 ...
 */
export const hello_RichardN = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const Richard_Noeske = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "rhn180003@utdallas.edu"
    }
