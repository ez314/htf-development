 ...
 */
export const hello_abby = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const abby_utd = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "thomasabigail2020@gmail.com"
    }
