 ...
 */
export const hello_farishah = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const farishah_nahrin = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "farishah.n1dfw@gmail.com"
    }
