 ...
 */
export const hello_daniel = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const daniel_honrales = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "dhh190000@utdallas.edu"
    }
