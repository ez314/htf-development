 ...
 */
export const hello_awab = async (request: Request, response: Response): Promise<void> => {
 ...
 */
export const awab_abdelrahim = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "ama190025@utdallas.edu"
    }
