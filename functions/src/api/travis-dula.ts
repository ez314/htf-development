 ...
 */
export const hello_travis = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const travis_dula = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "travisadula@gmail.com"
    }
