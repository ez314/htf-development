 ...
 */
export const hello_paulL = async (request: Request, response: Response): Promise<void> => {
    /**
 ...
 */
export const paul_lupeituu = async (request: Request, response: Response): Promise<void> => {
    const baseurl = functions.config().baseurl.firebase; // resolves to https://cloudfunctions.net
    const data = {
        email: "keahithrive@gmail.com"
    }
